...
$(document).ready(function () {
	...
	// Header text size
	fitty('.header-text-qr-text span', {
		minSize: 12,
	});
	// Header text size
	// Header text size
	fitty('.footer-title span', {
		minSize: 12,
	});
	// Header text size
	...
	$(window).on('scroll', function () {
		$navLink.each(function () {
			...
			if (windowTop > sectionTop - 1) {
				$menuLinks.removeClass('active').filter(this).addClass('active');
			} else {
	...
	$(".navbar-toggle").on("click", function () {
		...
		if ($('.navbar-toggle').hasClass('active')) {
			$('.nav-links').stop().slideDown('300');
		} else {
			$('.nav-links').stop().slideUp('300', function () {
				$('.nav-links').css('display', '');
			});
		}
	});
	$('.navbar-logo, .nav-item a').on('click', function () {
		if ($('.navbar-toggle').hasClass('active')) {
	...
	function initialize() {
		...
		$.getJSON("https://api.ipdata.co/?api-key=69db0ab4281ee7e9e1d0e3dec3dde348913cfd386ee472c1c0078a08", function (ipinfo) {
			console.log("ip:" + ipinfo.ip);
			console.log("location:" + ipinfo.latitude + "x" + ipinfo.longitude);

			$("#ipspan").html("Ваш IP: " + ipinfo.ip);
			$("#iporganisation").html("Интернет-провайдер: " + ipinfo.organisation);

			if (ipinfo.country_code == "UA") $("#ipstatus").html("Статус: Незащищенное соединение");
			if (ipinfo.country_code == "RU") $("#ipstatus").html("Статус: Незащищенное соединение");

			//	var table_body = data.lat + "x" +data.lon;
